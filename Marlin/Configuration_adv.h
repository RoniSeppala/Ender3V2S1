...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_ZETA_X   0.45       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel  //TODO: check e value after install
...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  #endif
  #define RETRACT_LENGTH               0.3   // (mm) Default retract length (positive value)  // MRiscoC Bowden
...
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     40  // (mm/s) Unload filament feedrate. This can be pretty fast.  // MRiscoC Increased filament unload speed
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   20  // (mm/s) Load filament feedrate. This can be pretty fast.  // MRiscoC Increased filament load speed
