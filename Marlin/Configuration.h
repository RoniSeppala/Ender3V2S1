...
#define CUSTOM_MACHINE_NAME "Ender3V2I4" //I3 means iteration 3
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 414 }  // Ender Configs //E-steps for micro swiss ng
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 1000 }  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20.3, -51.3, -0.42 }  //changed to micro swiss ng bltouch mount location
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 99.43
  #define XY_DIAG_BD 99.8
  #define XY_SIDE_AD 70.2558
